export const DCF_URL = "https://degencoinflip.com";
export const DCD_URL = "https://degencoindozer.com";
export const DS_URL = "https://degenspin.com/";

export const DFC_DISCORD_URL = "https://discord.com/invite/GnNacaEAyP";
export const NEKKRO_DISCORD_URL = "https://discord.gg/nekkronft";

export const DCF_TWITTER_URL = "https://twitter.com/degencoinflip";
export const DFC_TWITTER_URL = "https://twitter.com/degenfatcats";
export const NEKKRO_TWITTER_URL = "https://twitter.com/nekkronft";
...
export const careers = [
  {
    ...
    description:
      "Sit deserunt voluptate incididunt elit consequat qui proident consequat esse enim. Pariatur veniam excepteur sint exercitation occaecat duis magna ipsum laborum elit in ad et mollit.",
    isActive: true,
  },
  {
    title: "Front End Developer",
